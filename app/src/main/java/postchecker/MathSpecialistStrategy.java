...
public class MathSpecialistStrategy extends MathGenericStrategy implements PostRequirementStrategy {
    @Override
    public void doSpecificChecks() {
        ...
        if (twoBsNeeded.numCoursesSatisfyingGrade(3.0) < 2) {
            addFailure("You need at least a B in 2+ of " + twoBsNeeded);
        }
    }
}
